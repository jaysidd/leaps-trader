...
- Pipeline E2E tests: 194 tests in `backend/tests/pipeline/` covering all 7 layers + comprehensive PresetSelector tests with mock data — run with `python3 -m pytest tests/pipeline/ -v` (~1s, zero API calls)
